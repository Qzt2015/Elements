...
{
    [Serializable]
    public class Transformer_2 : Element //二绕阻变压器
    {
        public Transformer_2(float v1, float v2, float v3, float v4, int v5)
        {
            X = v1;
            Y = v2;
            W = v3;
        ...
        public override void Draw(Graphics g, Pen mypen,SolidBrush brush)
        {
            ...
            //RectangleF rectLine= new RectangleF(X, Y, W * B, H * B);
            //g.DrawRectangle(mypen, Rectangle.Round(rectLine));
        }
    }
}
